...
func EpInvoiceFactory(orderDetails models.OrdersHeader, refDistribId string) *fpdf.Fpdf {
	...
	pdf.SetFont("Arial", "B", 7.5)
	pdf.CellFormat(172, 8, "Grand Total(Total Unit Point After GST + Total S and H)", "1", 0, "C", true, 0, "")
	pdf.SetFont("Arial", "", 7.5)
	currX += 172
	pdf.SetXY(currX, currY)
